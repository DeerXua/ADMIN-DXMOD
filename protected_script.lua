-- ================================================================
-- protected_script.lua (SERVER SIDE MOD LOGIC PAYLOAD)
-- ================================================================
local BRPlayerCharacterBase = _G.Temp_BRPlayerCharacterBase.base
local FinalClassDecl = _G.Temp_BRPlayerCharacterBase.class
_G.TD_WeaponMap = {
    -- Assault Rifle (AR)
...
-- Bổ sung mapping theo ID số và từ khóa Tiếng Việt vào _G.TD_WeaponMap
pcall(function()
    local extraMappings = {
...
table.insert(StackESP, {
    ...
    SetFunc = function(_, value)
        ...
        table.insert(StackESP, {
            ...
            UI = AliasMap.TitleSwitcher,
            Text = "▶ ESP HIỂM HỌA (Cảnh báo địch ngắm)",
            ExpandIndex = 0,
        ...
        -- =========================================================================================
        local StackAimbotV2 = {
            { Key = "ModMenu_AT_Ex", UI = AliasMap.TitleSwitcher, Text = "▶ Bật Aimbot Roy & Custom", ExpandIndex = 0, GetFunc = function() return _G.TD_Settings.AimTouchEnable == 1 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchEnable = v and 1 or 0; _G.EnvRequiresUpdate = true; return true end },
            
            -- HIPFIRE (TÂM TRẮNG)
            { Key = "ModMenu_AT_Hip_Ex", UI = AliasMap.TitleSwitcher, Text = "   ▶ Aimbot Tâm Trắng", ExpandHandle = "ModMenu_AT_Ex", ExpandIndex = 0, GetFunc = function() return _G.TD_Settings.AimTouchHipfire == 1 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchHipfire = v and 1 or 0; _G.EnvRequiresUpdate = true; return true end },
            { Key = "ModMenu_AT_Hip_IgKnock", UI = AliasMap.Switcher, Text = "      Bỏ Qua Địch Knock", ExpandHandle = "ModMenu_AT_Hip_Ex", GetFunc = function() return _G.TD_Settings.AimTouchHipIgKnock == 1 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchHipIgKnock = v and 1 or 0 return true end },
            { Key = "ModMenu_AT_Hip_IgBot", UI = AliasMap.Switcher, Text = "      Bỏ Qua Bot", ExpandHandle = "ModMenu_AT_Hip_Ex", GetFunc = function() return _G.TD_Settings.AimTouchHipIgBot == 1 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchHipIgBot = v and 1 or 0 return true end },
            { Key = "ModMenu_AT_Hip_Vis", UI = AliasMap.Switcher, Text = "      Check Tường (VisCheck)", ExpandHandle = "ModMenu_AT_Hip_Ex", GetFunc = function() return _G.TD_Settings.AimTouchHipVisCheck == 1 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchHipVisCheck = v and 1 or 0 return true end },
            { Key = "ModMenu_AT_Hip_Prio", UI = AliasMap.Slider, Text = "      Ưu Tiên (1:Tâm 2:Gần 3:HP 4:%HP)", ExpandHandle = "ModMenu_AT_Hip_Ex", MinValue = 1, MaxValue = 4, min = 1, max = 4, Min = 1, Max = 4, GetFunc = function() return _G.TD_Settings.AimTouchHipPrio or 1 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchHipPrio = math.floor(v+0.5) return true end },
            { Key = "ModMenu_AT_Hip_Bone", UI = AliasMap.Slider, Text = "      Vị Trí (1:Đầu 2:Ngực 3:Bụng 4:Hông)", ExpandHandle = "ModMenu_AT_Hip_Ex", MinValue = 1, MaxValue = 4, min = 1, max = 4, Min = 1, Max = 4, GetFunc = function() return _G.TD_Settings.AimTouchHipBone or 1 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchHipBone = math.floor(v+0.5) return true end },
            ...
            { Key = "ModMenu_AT_Hip_Spd", UI = AliasMap.Slider, Text = "      Độ Mượt / Tốc Độ (1-100)", ExpandHandle = "ModMenu_AT_Hip_Ex", MinValue = 1, MaxValue = 100, min = 1, max = 100, GetFunc = function() return _G.TD_Settings.AimTouchHipSpeed or 50 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchHipSpeed = v return true end },
            { Key = "ModMenu_AT_Hip_FOV", UI = AliasMap.Slider, Text = "      Vòng FOV (1-100)", ExpandHandle = "ModMenu_AT_Hip_Ex", MinValue = 1, MaxValue = 100, min = 1, max = 100, GetFunc = function() return _G.TD_Settings.AimTouchHipFOV or 30 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchHipFOV = v return true end },
            { Key = "ModMenu_AT_Hip_Dist", UI = AliasMap.Slider, Text = "      Khoảng Cách (1-500m)", ExpandHandle = "ModMenu_AT_Hip_Ex", MinValue = 1, MaxValue = 100, min = 1, max = 100, GetFunc = function() return math.floor((_G.TD_Settings.AimTouchHipDist or 250) / 5) end, SetFunc = function(_, v) _G.TD_Settings.AimTouchHipDist = v * 5 return true end },

            -- AIMBOT SHOTGUN
            { Key = "ModMenu_AT_SG_Ex", UI = AliasMap.TitleSwitcher, Text = "   ▶ Aimbot Shotgun (Chỉ nhận Shotgun)", ExpandHandle = "ModMenu_AT_Ex", ExpandIndex = 0, GetFunc = function() return _G.TD_Settings.AimTouchSG == 1 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchSG = v and 1 or 0; _G.EnvRequiresUpdate = true; return true end },
            { Key = "ModMenu_AT_SG_AutoFire", UI = AliasMap.Switcher, Text = "      Tự Động Bắn lúc tự động bắn chịu khó bấm bắn nhận dame và auto bắn sẽ không lỗi dame", ExpandHandle = "ModMenu_AT_SG_Ex", GetFunc = function() return _G.TD_Settings.AimTouchSGAutoFire == 1 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchSGAutoFire = v and 1 or 0 return true end },
            { Key = "ModMenu_AT_SG_IgKnock", UI = AliasMap.Switcher, Text = "      Bỏ Qua Địch Knock", ExpandHandle = "ModMenu_AT_SG_Ex", GetFunc = function() return _G.TD_Settings.AimTouchSGIgKnock == 1 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchSGIgKnock = v and 1 or 0 return true end },
            { Key = "ModMenu_AT_SG_IgBot", UI = AliasMap.Switcher, Text = "      Bỏ Qua Bot", ExpandHandle = "ModMenu_AT_SG_Ex", GetFunc = function() return _G.TD_Settings.AimTouchSGIgBot == 1 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchSGIgBot = v and 1 or 0 return true end },
            { Key = "ModMenu_AT_SG_Vis", UI = AliasMap.Switcher, Text = "      Check Tường (VisCheck)", ExpandHandle = "ModMenu_AT_SG_Ex", GetFunc = function() return _G.TD_Settings.AimTouchSGVisCheck == 1 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchSGVisCheck = v and 1 or 0 return true end },
            { Key = "ModMenu_AT_SG_Prio", UI = AliasMap.Slider, Text = "      Ưu Tiên (1:Tâm 2:Gần 3:HP 4:%HP)", ExpandHandle = "ModMenu_AT_SG_Ex", MinValue = 1, MaxValue = 4, min = 1, max = 4, Min = 1, Max = 4, GetFunc = function() return _G.TD_Settings.AimTouchSGPrio or 1 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchSGPrio = math.floor(v+0.5) return true end },
            ...
            { Key = "ModMenu_AT_SG_Spd", UI = AliasMap.Slider, Text = "      Độ Mượt / Tốc Độ (1-100)", ExpandHandle = "ModMenu_AT_SG_Ex", MinValue = 1, MaxValue = 100, min = 1, max = 100, GetFunc = function() return _G.TD_Settings.AimTouchSGSpeed or 80 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchSGSpeed = v return true end },
            { Key = "ModMenu_AT_SG_FOV", UI = AliasMap.Slider, Text = "      Vòng FOV (1-100)", ExpandHandle = "ModMenu_AT_SG_Ex", MinValue = 1, MaxValue = 100, min = 1, max = 100, GetFunc = function() return _G.TD_Settings.AimTouchSGFOV or 40 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchSGFOV = v return true end },
            { Key = "ModMenu_AT_SG_Dist", UI = AliasMap.Slider, Text = "      Khoảng Cách (1-100m)", ExpandHandle = "ModMenu_AT_SG_Ex", MinValue = 1, MaxValue = 100, min = 1, max = 100, GetFunc = function() return _G.TD_Settings.AimTouchSGDist or 30 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchSGDist = v return true end },
            
            -- SCOPE ALL (SÚNG THƯỜNG KHI MỞ SCOPE)
            { Key = "ModMenu_AT_ScopeAll_Ex", UI = AliasMap.TitleSwitcher, Text = "   ▶ Aimbot Mở Scope", ExpandHandle = "ModMenu_AT_Ex", ExpandIndex = 0, GetFunc = function() return _G.TD_Settings.AimTouchScopeAll == 1 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchScopeAll = v and 1 or 0; _G.EnvRequiresUpdate = true; return true end },
            { Key = "ModMenu_AT_ScopeAll_IgKnock", UI = AliasMap.Switcher, Text = "      Bỏ Qua Địch Knock", ExpandHandle = "ModMenu_AT_ScopeAll_Ex", GetFunc = function() return _G.TD_Settings.AimTouchScopeIgKnock == 1 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchScopeIgKnock = v and 1 or 0 return true end },
            { Key = "ModMenu_AT_ScopeAll_IgBot", UI = AliasMap.Switcher, Text = "      Bỏ Qua Bot", ExpandHandle = "ModMenu_AT_ScopeAll_Ex", GetFunc = function() return _G.TD_Settings.AimTouchScopeIgBot == 1 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchScopeIgBot = v and 1 or 0 return true end },
            { Key = "ModMenu_AT_ScopeAll_Vis", UI = AliasMap.Switcher, Text = "      Check Tường (VisCheck)", ExpandHandle = "ModMenu_AT_ScopeAll_Ex", GetFunc = function() return _G.TD_Settings.AimTouchScopeVisCheck == 1 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchScopeVisCheck = v and 1 or 0 return true end },
            { Key = "ModMenu_AT_ScopeAll_Prio", UI = AliasMap.Slider, Text = "      Ưu Tiên (1:Tâm 2:Gần 3:HP 4:%HP)", ExpandHandle = "ModMenu_AT_ScopeAll_Ex", MinValue = 1, MaxValue = 4, min = 1, max = 4, Min = 1, Max = 4, GetFunc = function() return _G.TD_Settings.AimTouchScopePrio or 1 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchScopePrio = math.floor(v+0.5) return true end },
            { Key = "ModMenu_AT_ScopeAll_Bone", UI = AliasMap.Slider, Text = "      Vị Trí (1:Đầu 2:Ngực 3:Bụng 4:Hông)", ExpandHandle = "ModMenu_AT_ScopeAll_Ex", MinValue = 1, MaxValue = 4, min = 1, max = 4, Min = 1, Max = 4, GetFunc = function() return _G.TD_Settings.AimTouchScopeBone or 2 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchScopeBone = math.floor(v+0.5) return true end },
            ...
            { Key = "ModMenu_AT_ScopeAll_Spd", UI = AliasMap.Slider, Text = "      Độ Mượt / Tốc Độ (1-100)", ExpandHandle = "ModMenu_AT_ScopeAll_Ex", MinValue = 1, MaxValue = 100, min = 1, max = 100, GetFunc = function() return _G.TD_Settings.AimTouchScopeSpeed or 40 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchScopeSpeed = v return true end },
            { Key = "ModMenu_AT_ScopeAll_FOV", UI = AliasMap.Slider, Text = "      Vòng FOV (1-100)", ExpandHandle = "ModMenu_AT_ScopeAll_Ex", MinValue = 1, MaxValue = 100, min = 1, max = 100, GetFunc = function() return _G.TD_Settings.AimTouchScopeFOV or 20 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchScopeFOV = v return true end },
            { Key = "ModMenu_AT_ScopeAll_Dist", UI = AliasMap.Slider, Text = "      Khoảng Cách (1-500m)", ExpandHandle = "ModMenu_AT_ScopeAll_Ex", MinValue = 1, MaxValue = 100, min = 1, max = 100, GetFunc = function() return math.floor((_G.TD_Settings.AimTouchScopeDist or 300) / 5) end, SetFunc = function(_, v) _G.TD_Settings.AimTouchScopeDist = v * 5 return true end },
            { Key = "ModMenu_AT_ScopeAll_Pred", UI = AliasMap.Slider, Text = "      Dự Đoán Hướng Chạy", ExpandHandle = "ModMenu_AT_ScopeAll_Ex", MinValue = 0, MaxValue = 100, min = 0, max = 100, GetFunc = function() return _G.TD_Settings.AimTouchScopePred or 0 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchScopePred = v return true end },
            { Key = "ModMenu_AT_ScopeAll_Recoil", UI = AliasMap.Slider, Text = "      Bù Giật Tự Động Ghìm Tâm Khi Aim ( để tầm 3%-4% là ổn)", ExpandHandle = "ModMenu_AT_ScopeAll_Ex", MinValue = 0, MaxValue = 50, min = 0, max = 50, GetFunc = function() return _G.TD_Settings.AimTouchScopeRecoil or 0 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchScopeRecoil = v return true end },
            ...
            { Key = "ModMenu_AT_Sniper_IgKnock", UI = AliasMap.Switcher, Text = "      Bỏ Qua Địch Knock", ExpandHandle = "ModMenu_AT_Sniper_Ex", GetFunc = function() return _G.TD_Settings.AimTouchSniperIgKnock == 1 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchSniperIgKnock = v and 1 or 0 return true end },
            { Key = "ModMenu_AT_Sniper_IgBot", UI = AliasMap.Switcher, Text = "      Bỏ Qua Bot", ExpandHandle = "ModMenu_AT_Sniper_Ex", GetFunc = function() return _G.TD_Settings.AimTouchSniperIgBot == 1 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchSniperIgBot = v and 1 or 0 return true end },
            { Key = "ModMenu_AT_Sniper_Vis", UI = AliasMap.Switcher, Text = "      Check Tường (VisCheck)", ExpandHandle = "ModMenu_AT_Sniper_Ex", GetFunc = function() return _G.TD_Settings.AimTouchSniperVisCheck == 1 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchSniperVisCheck = v and 1 or 0 return true end },
            { Key = "ModMenu_AT_Sniper_Prio", UI = AliasMap.Slider, Text = "      Ưu Tiên (1:Tâm 2:Gần 3:HP 4:%HP)", ExpandHandle = "ModMenu_AT_Sniper_Ex", MinValue = 1, MaxValue = 4, min = 1, max = 4, Min = 1, Max = 4, GetFunc = function() return _G.TD_Settings.AimTouchSniperPrio or 1 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchSniperPrio = math.floor(v+0.5) return true end },
            { Key = "ModMenu_AT_Sniper_Bone", UI = AliasMap.Slider, Text = "      Vị Trí (1:Đầu 2:Ngực 3:Bụng 4:Hông)", ExpandHandle = "ModMenu_AT_Sniper_Ex", MinValue = 1, MaxValue = 4, min = 1, max = 4, Min = 1, Max = 4, GetFunc = function() return _G.TD_Settings.AimTouchSniperBone or 1 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchSniperBone = math.floor(v+0.5) return true end },
            ...
            { Key = "ModMenu_AT_Sniper_Spd", UI = AliasMap.Slider, Text = "      Độ Mượt / Tốc Độ (1-100)", ExpandHandle = "ModMenu_AT_Sniper_Ex", MinValue = 1, MaxValue = 100, min = 1, max = 100, GetFunc = function() return _G.TD_Settings.AimTouchSniperSpeed or 30 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchSniperSpeed = v return true end },
            { Key = "ModMenu_AT_Sniper_FOV", UI = AliasMap.Slider, Text = "      Vòng FOV (1-100)", ExpandHandle = "ModMenu_AT_Sniper_Ex", MinValue = 1, MaxValue = 100, min = 1, max = 100, GetFunc = function() return _G.TD_Settings.AimTouchSniperFOV or 20 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchSniperFOV = v return true end },
            { Key = "ModMenu_AT_Sniper_Dist", UI = AliasMap.Slider, Text = "      Khoảng Cách (1-500m)", ExpandHandle = "ModMenu_AT_Sniper_Ex", MinValue = 1, MaxValue = 100, min = 1, max = 100, GetFunc = function() return math.floor((_G.TD_Settings.AimTouchSniperDist or 400) / 5) end, SetFunc = function(_, v) _G.TD_Settings.AimTouchSniperDist = v * 5 return true end },
            { Key = "ModMenu_AT_Sniper_Pred", UI = AliasMap.Slider, Text = "      Dự Đoán Hướng Chạy (0-100)", ExpandHandle = "ModMenu_AT_Sniper_Ex", MinValue = 0, MaxValue = 100, min = 0, max = 100, GetFunc = function() return _G.TD_Settings.AimTouchSniperPred or 0 end, SetFunc = function(_, v) _G.TD_Settings.AimTouchSniperPred = v return true end }
        }
        ...
        AddToggle(StackEnv, "FAKE_HWID", "FAKE HWID (Chống Ghim ID Thiết Bị)")
...
-- -- =========================================================================================
-- [FIXED] THREAT ASSESSMENT ESP - Logic đúng chuẩn + VIS CHECK (ẨN KHI KHUẤT TƯỜNG)
-- =========================================================================================
...
local function UpdateThreatAssessmentESP(LocalPlayer, PlayerController, MyHUD)
    if _G.TD_GetVal("THREAT_ESP") ~= 1 then
        -- Nếu tắt, restore tất cả màu đã đổi
    ...
    -- Track enemy IDs đang được xử lý để cleanup cache cũ
    local processedIds = {}
    ...
    for _, enemy in pairs(allChars) do
        ...
        -- ===== VISIBILITY CHECK VỚI CACHE (0.2s) - Ẩn khi khuất tường =====
        ...
        -- ===== LOGIC ĐÚNG: Check xem địch có đang NGẮM VÀO MÌNH không =====
        ...
        -- ===== XỬ LÝ HIỂN THỊ (CÓ VIS CHECK) =====
        if isFiringAtMe and isVisible then
            -- TRƯỜNG HỢP 1: Địch đang NGẮM VÀ BẮN + NHÌN THẤY → CẢNH BÁO ĐỎ NHÁY
            ...
            MyHUD:AddDebugText("ĐANG NGẮM BẮN BẠN", enemy, 0.3, 
        ...
        elseif isAimingAtMe and isVisible then
            -- TRƯỜNG HỢP 2: Địch đang nhìn về mình + NHÌN THẤY → CẢNH BÁO VÀNG
            if ThreatESP_OriginalColors[eId] then
                pcall(function()
                    if slua.isValid(enemy.Mesh) then
                        local orig = ThreatESP_OriginalColors[eId]
            ...
            MyHUD:AddDebugText("ĐANG NHÌN VỀ BẠN", enemy, 0.3,
                {X=0, Y=0, Z=110}, {X=0, Y=0, Z=110},
                {R=255, G=200, B=0, A=255}, true, false, true, nil, 0.7, true)
        else
            -- TRƯỜNG HỢP 3: KHÔNG nhìn về mình HOẶC BỊ KHUẤT TƯỜNG → Restore màu gốc + Ẩn text
            if ThreatESP_OriginalColors[eId] then
                pcall(function()
                    if slua.isValid(enemy.Mesh) then
                        local orig = ThreatESP_OriginalColors[eId]
            ...
            -- Không vẽ text cảnh báo → tự động ẩn
        end
        
        ::continue_threat::
    end

    -- Cleanup cache enemy đã chết/rời đi
                    ...
                    if not isEnemyDead then
                        ...
                        if espWeaponStance and Valid(MyHUD) and distM <= 400 then
                            pcall(function()
                                ...
                                local stateText = string.format("%s [%s]", enemy.TD_CachedWeaponName or "Tay Không", poseText)
...
-- ================================================================
-- OVERRIDE PACKAGE LOADED (SYNC GAME ENGINE CLASS OVERRIDE)
-- ================================================================
pcall(function()
    package.loaded["GameLua.GameCore.Gameplay.BRPlayerCharacterBase"] = FinalClassDecl
end)
